...
function VlanDelete() {
  ...
  const handleMod = () => {
    ...
    const url = "http://localhost/cdot/logged-page/vlandelete.php";
    if (!vid) {
      setVal(0);
  ...
  return (
    <>
      <div className="card-body">
        <h3 className="card-title">VLAN Delete</h3>
        <br />
      ...
      >
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">Delete {vid} Account</div>

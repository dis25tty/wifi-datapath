  ...
  <div id="navdiv">
   ...
   <h2><li style="color:white;text-alignment:center;display:block;"><b>CONFIGURE</b></li></h2>
    <li>
      ...
      <ul id="userSubMenu" className="sub-menu" style="display: none;">
    ...
    <li>
      ...
      <ul id="vlanSubMenu" className="sub-menu" style="display: none;">
    ...
    <li>
      ...
      <ul id="apSubMenu" className="sub-menu" style="display: none;">
    ...
    <ul id="backupSubMenu" className="sub-menu" style="display: none;">
...
?>
  ...
  <div className="content" id="userAddContent" >
...
<div className="content" id="userDeleteContent" >
 ...
 <h2>USER DELETE</h2><br><br>
    ...
    <div className="content" id="userModifyContent" >
...
<div className="content" id="vlanViewContent" >
...
<div className = "content" id = "vlanAddContent" >
...
<div className="content" id="vlanDeleteContent" >
 ...
 <div className = "content" id = "vlanModifyContent" >
...
<div className="content" id="apViewContent" >
 ...
 <div className="content" id="apAddContent" >
...
<div className="content" id="apDeleteContent" >
...
<div className="content" id="apModifyContent" >
...
<div className="content" id="backupViewContent" >
  <h2>View</h2>
  <!-- Add your user view content here -->
</div>

 <div className="content" id="backupAddContent" >
  <h2>ADD RULE</h2>
  <!-- Add your user view content here -->
</div>

 <div className="content" id="backupDeleteContent" >
  <h2>DELETE </h2>
  <!-- Add your user view content here -->
</div>

 <div className="content" id="backupModifyContent" >
  <h2>MODIFY RULE</h2>
  <!-- Add your user view content here -->
</div>
